            ...
            if ("quit".equals(line)) {
                ...
                do {
                    ...
                    if (existsTopicWithName(topicName)) {
                        System.out.println(
                                "The name '" + topicName + "' is already in use. Please choose another one.");
                    }
                ...
                if (subscribedTopics.size() < 1) {
                    System.out.println("You are not subscribed to any topic. You can only modify topics which you are subscribed to.");
                    continue;
                }
